...
import 'package:Pigeon/src/data/local_database/message_table.dart';
import 'package:Pigeon/src/data/local_database/user_table.dart';
...
class DBProvider {
  ...
  Future _open() async {
    ...
    String path = join(documentsDirectory.path, "talk_with_me.db");
